...
Set a default project name (the same name as the resource is fine)
...
## 8. Copy your API key and project endpoint into your .env

In the Foundry portal you'll see an **API Key** and a **Project endpoint**. 
...
In the Foundry portal, click **Explore models**.
...
You're all set. Jump back to the set up steps to [Test your setup](content/1-Environment_setup/readme.md#3-test-your-setup) to verify everything works.
